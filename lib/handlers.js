...
handlers.sessionCreate = (data, callback) => {
    if (data.method == 'get') {
        const templateData = {
            'head.title': 'Log in to yout Account',
            'head.description': 'Please neter your phone number and password to access your account.'
        };
...
handlers.accountEdit = (data, callback) => {
    if(data.method == 'get') {
        const templateData = {
            'head.title': 'Edit your existing Account',
            'head.description': 'Please enter your phone number and password to update your data.'
        }
...
handlers.checksList = (data, callback) => {
    if(data.method == 'get') {
        const templateData = {
            'head.title': 'See your checks list',
            'head.description': 'Have a look at your checks list table.'
        }
...
handlers.checksCreate = (data, callback) => {
    if(data.method == 'get') {
        const templateData = {
            'head.title': 'Create your check',
            'head.description': 'Create your check by entering data.'
        }
...
handlers.checksEdit = (data, callback) => {
    if(data.method == 'get') {
        const templateData = {
            ...
            'head.description': 'Edit your checks by entering data.'
        }
...
handlers.accountDeleted = (data, callback) => {
    if(data.method == 'get') {
        const templateData = {
            ...
            'head.description': 'You successfully deleted your account.'
        }
