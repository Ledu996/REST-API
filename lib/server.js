...
server.router = {
    ...
    'session/create' : handlers.sessionCreate, // redirect checks all () log in (broj-telefona, sifra) vezano za tokene
    'session/deleted' : handlers.sessionDeleted, // poruka odjavili ste se
    'checks/all' : handlers.checksList, // lista svih cekova(dugme za check i delete) <table> podaci o cekovima svaki red jedan cek
    'checks/create' : handlers.checksCreate, // forma sa svim podacima vezani za chekove 
    'checks/edit' : handlers.checksEdit, // edit check podatke
    'ping': handlers.ping,
